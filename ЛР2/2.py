...
class Library:
    ...
    def __init__(self, books: list = [], id_spis: dict = {}):
        self.books = books
        self.id_spis = id_spis
...
if __name__ == '__main__':
    ...
    for i in range(len(list_books)):
        id_spis[list_books[i].id] = i

    library_with_books = Library(books=list_books, id_spis=id_spis)  # инициализируем библиотеку с книгами
